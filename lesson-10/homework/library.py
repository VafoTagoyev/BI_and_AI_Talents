...
def main():
    ...
    library.borrow_book("Vafo", "The Alchemist")
    library.borrow_book("Vafo", "Harry Potter")
    library.borrow_book("Vafo", "The Lord of the Rings")
    library.borrow_book("Someone", "The Hobbit")
    library.return_book("Vafo", "The Alchemist")
